...
module.exports = {
    logAttempt: function (userId, userName) {
    ...
    checkPointerFree: async function (userId) {
    ...
    registerPartner: function (userId, type, name) {
    ...
    freePartner: async function (userId) {
        return await database.ref('/partner/' + userId).once('value').then(snapshot => {
